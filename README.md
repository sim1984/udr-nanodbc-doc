...
Далее библиотеку необходимо зарегистрировать в вашей базе данных. Для этого необходимо выполнить скрипт [nanodbc_install.sql](https://github.com/sim1984/udr-nanodbc-doc/tree/main/sql/nanodbc_install.sql) или последовательно следующие скрипты:
